$(document).ready(function () {
  ...
  //내용 모음 (메뉴 클릭했을 때 나오는 내용)
  var noticeLi = $(".notice-cont > li");
  //내용을 보여주고, 포커스를 이동하는
  // 사용자 지정 함수를 실행 : showNotice()
  ...
  var alramCount = $(".alram-tab-cont");
  $.each(alramA, function (index, item) {
    $(this).click(function (e) {
      e.preventDefault();
      alramCount.removeClass("alram-tab-cont-focus");
      alramCount.eq(index).addClass("alram-tab-cont-focus");
      alramA.removeClass("alram-tab-menu-focus");
      alramCount.eq(index).addClass("alram-tab-menu-focus");
    });
  });
  // 알람탭 메뉴 스와이퍼 ( 공고알림, 교육 및 기타알림, 월별 행사 캘린더)
